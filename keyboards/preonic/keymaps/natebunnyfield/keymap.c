...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    switch (keycode) {
    case TR_C:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose =  0; break;
    case TR_G:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose = -5; break;
    case TR_D:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose =  2; break;
    case TR_A:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose = -3; break;
    case TR_E:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose =  4; break;
    case TR_B:  midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose = -1; break;
    case TR_Gb: midi_config.octave = MI_OC0 - MIDI_OCTAVE_MIN; midi_config.transpose =  6; break;
    case TR_Db: midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose =  1; break;
    case TR_Ab: midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose = -4; break;
    case TR_Eb: midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose =  3; break;
    case TR_Bb: midi_config.octave = MI_OC1 - MIDI_OCTAVE_MIN; midi_config.transpose = -2; break;
    case TR_F:  midi_config.octave = MI_OC0 - MIDI_OCTAVE_MIN; midi_config.transpose =  5; break;
    }
    return true;
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_preonic_2x2u(
        ...
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______, KC_MPRV, _______, _______, _______, KC_DEL,  KC_NO,            KC_END,           KC_PGUP, KC_PGDN),
